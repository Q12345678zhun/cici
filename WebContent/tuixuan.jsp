...
<html>
	<head>
		...
		<title>My JSP 'tuixuan.jsp' starting page</title>
...
-->
	...
	<body>
		<table align="center" width="850px" class="stripe" cellspacing="0">
			...
			<tbody>
				<s:iterator value="#request.selectedCourse" id="course">
					<tr>
						<td>
						...
						<td>
							<s:a href="tuixuanAction.action?course.cid=%{#course.cid}">退选</s:a>
						</td>
					</tr>
